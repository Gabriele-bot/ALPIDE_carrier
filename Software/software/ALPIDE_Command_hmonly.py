	...
	while exit == 0:
		...
		if ip == "pon":
			...
			if powered:
				send_cmd(initialize)
				get_status()
				#maskPixel(377,214, True)
				#maskPixel(98,170, True)
				#maskPixel(879,132, True)
				#maskPixel(311,348, True)
				#maskPixel(210,287, True)
				#maskPixel(668,467, True)
				#maskPixel(365,118, True)
				#maskPixel(132,339, True)
				#maskPixel(449,74, True)
				#maskPixel(726,169, True)
				#maskPixel(813,456, True)
				#maskPixel(584,269, True)
				#maskPixel(951,424, True)
				#maskPixel(971,370, True)
			else:
