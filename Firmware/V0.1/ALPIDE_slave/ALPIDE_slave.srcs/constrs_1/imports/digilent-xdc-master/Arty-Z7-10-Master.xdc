...
## Pmod Header JA
#set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { pwr_enable }]; #IO_L17P_T2_34 Sch=JA1_P
...
#set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { CTRL }]; #IO_L7N_T1_34 Sch=JA2_N
...
#set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { DCLK }]; #IO_L22N_T3_34 Sch=JA4_N
#create_clock -add -name DCLK_clk_pin -period 100 -waveform {0 50} [get_ports { DCLK}];
...
#set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { CTRL }]; #IO_L1P_T0_34 Sch=JB2_P
