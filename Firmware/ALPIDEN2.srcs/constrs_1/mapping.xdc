...
## Pmod Header JB
#set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { CTRL_io }]; #IO_L11P_T1_SRCC_15 Sch=jb_p[1]
...
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { DCLK_o }]; #IO_L24N_T3_RS0_15 Sch=jb_n[4]
