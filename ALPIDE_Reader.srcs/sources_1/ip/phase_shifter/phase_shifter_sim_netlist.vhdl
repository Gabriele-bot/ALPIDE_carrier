...
--               D:/Progetti_vivado/ALPIDE_Reader/ALPIDE_Reader.srcs/sources_1/ip/phase_shifter/phase_shifter_sim_netlist.vhdl
...
entity phase_shifter_phase_shifter_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of phase_shifter_phase_shifter_clk_wiz : entity is "phase_shifter_clk_wiz";
end phase_shifter_phase_shifter_clk_wiz;

architecture STRUCTURE of phase_shifter_phase_shifter_clk_wiz is
  signal clk_in1_phase_shifter : STD_LOGIC;
  signal clk_out1_phase_shifter : STD_LOGIC;
  signal clk_out1_phase_shifter_en_clk : STD_LOGIC;
  signal clk_out2_phase_shifter : STD_LOGIC;
  signal clk_out2_phase_shifter_en_clk : STD_LOGIC;
  signal clkfbout_buf_phase_shifter : STD_LOGIC;
  signal clkfbout_phase_shifter : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_phase_shifter,
      O => clkfbout_buf_phase_shifter
    );
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out1_phase_shifter,
      O => clk_out1_phase_shifter_en_clk
    );
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out2_phase_shifter,
      O => clk_out2_phase_shifter_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      STARTUP_WAIT => false
        ...
        port map (
      CLKFBIN => clkfbout_buf_phase_shifter,
      CLKFBOUT => clkfbout_phase_shifter,
      CLKFBOUTB => NLW_mmcm_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcm_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_phase_shifter,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_phase_shifter,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_phase_shifter,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_phase_shifter_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg1(0),
      R => '0'
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out2_phase_shifter_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg2(0),
      R => '0'
...
entity phase_shifter is
  ...
  attribute NotValidForBitStream of phase_shifter : entity is true;
end phase_shifter;

architecture STRUCTURE of phase_shifter is
begin
inst: entity work.phase_shifter_phase_shifter_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
